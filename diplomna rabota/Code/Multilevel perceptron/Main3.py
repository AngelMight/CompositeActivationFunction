...
activation2 = Activation.Activation_ReLU()# A hidden layer
...
for epoch in range(11001):
    ...
    dense2.forward(activation1.output) # A hidden layer - begin
    activation2.forward(dense2.output) # A hidden layer - END
    ...
    dense2.backward(activation2.dinputs)# A hidden layer
    activation1.backward(dense2.dinputs)# A hidden layer
...
activation1.forward(dense1.output)
dense2.forward(activation1.output)# A hidden layer
activation2.forward(dense2.output)# A hidden layer
denseOut.forward(activation2.output)
